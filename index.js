...
function op(operation) {
    ...
    switch (operation[1]) {
        case "x":
            ...
            let fixmulResult = mulResult.toFixed(3);
            return fixmulResult.toString(10);
        case "/":
            let divResult = num1 / num2;
            let fixdivResult = divResult.toFixed(3);
            return fixdivResult.toString(10);
        case "+":
            let sumResult = num1 + num2;
            return sumResult.toString(10);
        case "-":
            let subResult = num1 - num2;
            return subResult.toString(10);
        case "^":
